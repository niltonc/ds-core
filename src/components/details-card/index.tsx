  ...
  return (
    <>
      <details className="card">
        ...
        <p>
          Jupiter (Latin: Iūpiter or Iuppiter,[14] from Proto-Italic *djous
          "day, sky" + *patēr "father", thus "sky father" Greek: Δίας or
          Ζεύς),[15] also known as Jove (gen. Iovis [ˈjɔwɪs]), is the god of the
          sky and thunder, and king of the gods in ancient Roman religion and
          mythology. Jupiter was the chief deity of Roman state religion
          throughout the Republican and Imperial eras, until Christianity became
          the dominant religion of the Empire. In Roman mythology, he negotiates
          with Numa Pompilius, the second king of Rome, to establish principles
