        ...
        <div className="modal">
          ...
          <div className="modal__content">
            <div className="modal__image">
              <img
                src="https://images.unsplash.com/photo-1618220179428-22790b461013?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=3027&q=80"
                alt="Modal Image"
              />
            </div>
            <h1>
