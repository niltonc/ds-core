  ...
  return (
    <div className="container">
      ...
      <ul className={`list-items ${isOpen ? 'open' : ''}`}>
        <li
          className={`item ${
            selectedItems.includes('HTML & CSS') ? 'checked' : ''
          }`}
          onClick={() => handleItemClick('HTML & CSS')}
        >
        ...
        <li
          className={`item ${
            selectedItems.includes('Bootstrap') ? 'checked' : ''
          }`}
          onClick={() => handleItemClick('Bootstrap')}
        >
          <span className="checkbox">
            <i className="fa-solid fa-check check-icon" />
          </span>
        ...
        <li
          className={`item ${
            selectedItems.includes('JavaScript') ? 'checked' : ''
          }`}
        ...
        <li
          className={`item ${
            selectedItems.includes('Node.Js') ? 'checked' : ''
          }`}
          onClick={() => handleItemClick('Node.Js')}
        >
          <span className="checkbox">
            <i className="fa-solid fa-check check-icon" />
          </span>
        ...
        <li
          className={`item ${
            selectedItems.includes('React JS') ? 'checked' : ''
          }`}
          onClick={() => handleItemClick('React JS')}
        >
          <span className="checkbox">
            <i className="fa-solid fa-check check-icon" />
          </span>
        ...
        <li
          className={`item ${
            selectedItems.includes('Mango DB') ? 'checked' : ''
          }`}
          onClick={() => handleItemClick('Mango DB')}
        >
          <span className="checkbox">
            <i className="fa-solid fa-check check-icon" />
          </span>
